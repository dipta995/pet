    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php 
                $petslist = $select->selerecentviewunlimit($start_form,$per_page,$customer_id);
                            if ($petslist) {
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination">
                              ...
                              <?php echo "<li><a href='shopone.php?page=1'>".'&laquo;'."Previous</a></li>"; 
            for ($i=1; $i <= $total_page; $i++) { 
                echo "<li><a href='shopone.php?page=".$i."'>".$i."</a>";
            }; ?>
         
       <?php echo "<li><a href='shopone.php?page=1'>".'&raquo;'."Next</a></li>"; ?>
